...
const staticRoutes = [
  ...
  { path: "/average-net-worth-by-age-canada",          freq: "monthly", priority: 0.9  },
  { path: "/average-retirement-savings-by-age",        freq: "monthly", priority: 0.9  },
  { path: "/fire-calculator",                          freq: "weekly",  priority: 0.9  },
  { path: "/statistics",                               freq: "weekly",  priority: 0.85 },
