...
export const seoNodes = {
  ...
  "/blog/how-compound-interest-works": {
    ...
    desc: "The mechanics of compound growth explained simply.",
    links: [
  ...
  "/blog/daily-vs-monthly-compound-interest": {
    ...
    cluster: "compound-interest",
    desc: "How compounding frequency affects your returns.",
    links: [
      "/calculators/compound-interest-calculator",
      "/calculators/investment-calculator",
      "/calculators/retirement-calculator",
  ...
  "/blog/compound-interest-examples": {
    ...
    cluster: "compound-interest",
    desc: "Real scenarios showing compound growth over time.",
    links: [
      "/calculators/compound-interest-calculator",
      "/calculators/investment-calculator",
      "/calculators/retirement-calculator",
  ...
  "/blog/best-compound-interest-investments": {
    ...
    cluster: "compound-interest",
    desc: "Top investment vehicles that maximise compounding.",
    links: [
      "/calculators/investment-calculator",
      "/calculators/compound-interest-calculator",
      "/calculators/retirement-calculator",
  ...
  "/blog/compound-interest-calculator-canada": {
    ...
    cluster: "compound-interest",
    desc: "Canadian-specific compounding with TFSA and RRSP context.",
    links: [
      "/calculators/compound-interest-calculator",
      "/calculators/investment-calculator",
